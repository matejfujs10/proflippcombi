...
export const translations = {
  ...
  faqX: {
    ...
    a1: { SL: "Pošlješ povpraševanje preko obrazca ali nas pokličeš. V nekaj urah ti pošljemo potrditev v kolikor je izbrani termin prost, se dogovorimo za ostale podrobnosti in lokacijo prevzema.", EN: "Send an inquiry via the form or give us a call. Within a few hours we'll send you a confirmation if your selected date is available, and we'll arrange the remaining details and pickup location.", DE: "Sende eine Anfrage über das Formular oder ruf uns an. Innerhalb weniger Stunden senden wir dir eine Bestätigung, sofern der gewünschte Termin frei ist, und vereinbaren die weiteren Details und den Abholort.", HR: "Pošalji upit preko obrasca ili nas nazovi. U nekoliko sati šaljemo ti potvrdu ako je odabrani termin slobodan te dogovaramo ostale detalje i lokaciju preuzimanja." },
    ...
    a2: { SL: "Prevzem je v Murski Soboti, po želji in z doplačilom dostavimo vozilo na dogovorjeni kraj.", EN: "Pickup is in Murska Sobota; on request and for an additional fee we can deliver the vehicle to an agreed location.", DE: "Abholung in Murska Sobota; auf Wunsch und gegen Aufpreis liefern wir das Fahrzeug an einen vereinbarten Ort.", HR: "Preuzimanje je u Murskoj Soboti; po želji i uz doplatu dostavljamo vozilo na dogovoreno mjesto." },
  ...
  blog: {
    ...
    articles: {
      a1: {
        title: { SL: "Zakaj je PROFLIPP KOMBI najboljša izbira za vaš naslednji prevoz?", EN: "Why is PROFLIPP KOMBI the best choice for your next trip?", DE: "Warum ist PROFLIPP KOMBI die beste Wahl für deine nächste Fahrt?", HR: "Zašto je PROFLIPP KOMBI najbolji izbor za vaš sljedeći prijevoz?" },
        excerpt: { SL: "Okreten, ekonomičen in pripravljen na vse – mesto, gore ali obalo.", EN: "Agile, economical and ready for anything – city, mountains or coast.", DE: "Wendig, sparsam und für alles bereit – Stadt, Berge oder Küste.", HR: "Okretan, ekonomičan i spreman na sve – grad, planine ili obala." },
        body: { SL: "Pri izbiri vozila za prevoz ali potovanje pogosto iščemo ravnovesje med prostornostjo in okretnostjo. PROFLIPP kombi ponuja prav to – je izjemno preprost za vožnjo, hiter in odziven, hkrati pa ponuja dovolj prostora za vse vaše potrebe. Ena njegovih največjih prednosti je izjemno majhna poraba goriva, kar bistveno zniža stroške vašega potovanja.\n\nKer gre za kompaktno in pametno zasnovano vozilo, nimate popolnoma nobenih omejitev pri vožnji v mestnih središčih. Brez težav boste dostopali do ozkih ulic, se zapeljali v podzemne garaže ali parkirali na standardnih parkirnih mestih, kjer večji kombiji odpovejo. Za piko na i pa je vozilo izjemno prilagodljivo za enostavno nalaganje, opremljeno z moderno opremo za udobno vožnjo, za najem pa potrebujete le navadno vozniško dovoljenje B kategorije. Hitro, preprosto in brez stresa! Simplicity is the Key!", EN: "When choosing a vehicle for transport or travel, we often look for the balance between space and agility. PROFLIPP van offers exactly that – it is extremely easy to drive, fast and responsive, while offering enough space for all your needs. One of its biggest advantages is its remarkably low fuel consumption, which significantly reduces travel costs.\n\nBecause it is a compact and smartly designed vehicle, you have absolutely no limitations driving in city centers. You'll easily access narrow streets, drive into underground garages or park in standard spots where bigger vans give up. On top of that, the van is extremely flexible for easy loading, equipped with modern gear for comfortable driving, and you only need a regular B category driver's license to rent it. Fast, simple and stress-free! Simplicity is the Key!", DE: "Bei der Wahl eines Fahrzeugs für Transport oder Reisen suchen wir oft das Gleichgewicht zwischen Platz und Wendigkeit. Der PROFLIPP Kombi bietet genau das – er ist extrem einfach zu fahren, schnell und reaktionsschnell und bietet gleichzeitig genügend Platz für all deine Bedürfnisse. Einer seiner größten Vorteile ist der bemerkenswert niedrige Kraftstoffverbrauch, der die Reisekosten deutlich senkt.\n\nDa es sich um ein kompaktes und intelligent konzipiertes Fahrzeug handelt, hast du in der Innenstadt absolut keine Einschränkungen. Du erreichst mühelos enge Straßen, fährst in Tiefgaragen oder parkst auf normalen Parkplätzen, wo größere Kombis aufgeben. Zudem ist das Fahrzeug extrem flexibel beim Beladen, mit moderner Ausstattung für komfortables Fahren ausgestattet, und für die Miete benötigst du nur einen normalen Führerschein der Klasse B. Schnell, einfach und stressfrei! Simplicity is the Key!", HR: "Pri odabiru vozila za prijevoz ili putovanje često tražimo ravnotežu između prostranosti i okretnosti. PROFLIPP kombi nudi upravo to – izuzetno je jednostavan za vožnju, brz i osjetljiv, a istovremeno nudi dovoljno prostora za sve vaše potrebe. Jedna od njegovih najvećih prednosti je iznimno mala potrošnja goriva, što značajno smanjuje troškove putovanja.\n\nBudući da se radi o kompaktnom i pametno dizajniranom vozilu, nemate apsolutno nikakvih ograničenja u vožnji po centrima gradova. Bez problema ćete pristupiti uskim ulicama, ući u podzemne garaže ili parkirati na standardnim parkirnim mjestima gdje veći kombiji zataje. Za šlag na kraju, vozilo je izuzetno prilagodljivo za jednostavan utovar, opremljeno modernom opremom za udobnu vožnju, a za najam je potrebna samo obična vozačka dozvola B kategorije. Brzo, jednostavno i bez stresa! Simplicity is the Key!" },
      },
      a2: {
        title: { SL: "Lepote kampiranja: Svoboda, ki jo doživite le na štirih kolesih", EN: "The beauty of camping: Freedom you only experience on four wheels", DE: "Die Schönheit des Campings: Freiheit, die du nur auf vier Rädern erlebst", HR: "Ljepote kampiranja: Sloboda koju doživite samo na četiri kotača" },
        excerpt: { SL: "Sami določate ritem. Vsak ovinek prinaša novo avanturo.", EN: "You set the rhythm. Every turn brings a new adventure.", DE: "Du bestimmst den Rhythmus. Jede Kurve bringt ein neues Abenteuer.", HR: "Sami određujete ritam. Svaki zavoj donosi novu avanturu." },
        body: { SL: "Kampiranje že dolgo ni več le postavljanje šotora – postalo je sinonim za popolno svobodo in umik od vsakodnevnega drvečega tempa. Ko potujete s kombijem, sami določate svoj ritem. Vam lokacija ni všeč? Enostavno obrnete ključ in odpeljete naprej. Najlepši del kampiranja je prebujanje s pogledom na naravo, tik ob obali reke, sredi gora ali ob robu gozda, stran od hotelskih gneč in strogih urnikov.\n\nPotovanje s predelanim ali prilagojenim kombijem vam omogoča, da imate vse svoje udobje vedno s seboj, hkrati pa vas uči minimalizma in povezovanja z naravo. Vsak ovinek prinaša novo avanturo, vsak večer pa nov, nepozaben sončni zahod. Doživite svet brez filtrov in omejitev.", EN: "Camping has long stopped being just pitching a tent – it has become a synonym for total freedom and escape from the everyday rushing pace. When you travel with a van, you set your own rhythm. Don't like the spot? Just turn the key and drive on. The most beautiful part of camping is waking up with a view of nature, right by a riverbank, in the middle of the mountains or on the edge of a forest, far from hotel crowds and strict schedules.\n\nTravelling with a converted or adapted van means you always have all your comfort with you, while also teaching you minimalism and connection with nature. Every turn brings a new adventure, every evening a new, unforgettable sunset. Experience the world without filters or limits.", DE: "Camping ist längst nicht mehr nur Zeltaufschlagen – es ist zum Synonym für völlige Freiheit und Flucht aus dem hektischen Alltag geworden. Wenn du mit einem Kombi reist, bestimmst du deinen eigenen Rhythmus. Gefällt dir der Platz nicht? Einfach Schlüssel drehen und weiterfahren. Der schönste Teil des Campings ist das Aufwachen mit Blick auf die Natur, direkt am Flussufer, mitten in den Bergen oder am Waldrand, weit weg von Hotelmassen und strengen Zeitplänen.\n\nMit einem umgebauten Kombi hast du allen Komfort immer dabei und lernst gleichzeitig Minimalismus und Verbundenheit mit der Natur. Jede Kurve bringt ein neues Abenteuer, jeder Abend einen neuen, unvergesslichen Sonnenuntergang. Erlebe die Welt ohne Filter und ohne Grenzen.", HR: "Kampiranje već dugo nije samo postavljanje šatora – postalo je sinonim za potpunu slobodu i bijeg od svakodnevnog užurbanog tempa. Kad putujete s kombijem, sami određujete svoj ritam. Ne sviđa vam se lokacija? Jednostavno okrenete ključ i odvezete se dalje. Najljepši dio kampiranja je buđenje s pogledom na prirodu, uz obalu rijeke, usred planina ili na rubu šume, daleko od hotelskih gužvi i strogih rasporeda.\n\nPutovanje preuređenim kombijem omogućuje vam da uvijek imate sav svoj komfor sa sobom, dok vas istovremeno uči minimalizmu i povezivanju s prirodom. Svaki zavoj donosi novu avanturu, svaka večer nov, nezaboravan zalazak sunca. Doživite svijet bez filtera i ograničenja." },
      },
      a3: {
        title: { SL: "Mini vodnik za začetnike: Kako se pripraviti na prvi 'Vanlife' vikend?", EN: "Mini guide for beginners: How to prepare for your first 'Vanlife' weekend?", DE: "Mini-Guide für Anfänger: Wie bereitest du dich auf dein erstes Vanlife-Wochenende vor?", HR: "Mini vodič za početnike: Kako se pripremiti za prvi 'Vanlife' vikend?" },
        excerpt: { SL: "Pametna in minimalistična priprava je ključ do nepozabnega vikenda.", EN: "Smart, minimalist preparation is the key to an unforgettable weekend.", DE: "Eine clevere, minimalistische Vorbereitung ist der Schlüssel zu einem unvergesslichen Wochenende.", HR: "Pametna i minimalistička priprema ključ je za nezaboravan vikend." },
        body: { SL: "Če se prvič odpravljate na kampiranje ali potovanje s kombijem, je ključ do uspeha pametna in minimalistična priprava. Prednost potovanja z okretnim kombijem je, da ne potrebujete ogromno krame, saj je prostor izkoriščen izjemno funkcionalno. Spakirajte le najnujnejše: večnamenska oblačila, osnovno posodo za kuhanje na prostem, udobno posteljnino in dobro svetilko.\n\nPreden odrinete, si okvirno začrtajte pot, a pustite prostor za spontanost. Preverite lokacije kampov ali urejenih postajališč (postajališča za avtodome), kjer lahko varno prenočite. Kampiranje s kombijem vas bo hitro naučilo, da za nepozaben vikend sploh ne potrebujete veliko materialnih stvari – le dobro družbo, topel večer pod zvezdami in pravo vozilo, ki vas zanesljivo pripelje do cilja.", EN: "If you're heading out camping or van travelling for the first time, the key to success is smart, minimalist preparation. The advantage of travelling with an agile van is that you don't need a ton of stuff, because the space is used extremely functionally. Pack only the essentials: versatile clothes, basic outdoor cookware, comfortable bedding and a good lantern.\n\nBefore you leave, sketch out a rough route, but leave room for spontaneity. Check the locations of campsites or dedicated motorhome stops where you can safely spend the night. Camping with a van will quickly teach you that you don't need many material things for an unforgettable weekend – just good company, a warm evening under the stars and the right vehicle to reliably bring you to your destination.", DE: "Wenn du zum ersten Mal mit dem Kombi campst oder reist, ist der Schlüssel zum Erfolg eine clevere, minimalistische Vorbereitung. Der Vorteil eines wendigen Kombis ist, dass du nicht viel Krempel brauchst, weil der Raum extrem funktional genutzt wird. Packe nur das Nötigste: vielseitige Kleidung, einfaches Outdoor-Kochgeschirr, bequeme Bettwäsche und eine gute Lampe.\n\nBevor du losfährst, skizziere grob deine Route, lass aber Raum für Spontaneität. Prüfe Campingplätze oder ausgewiesene Stellplätze, an denen du sicher übernachten kannst. Camping mit dem Kombi wird dich schnell lehren, dass du für ein unvergessliches Wochenende keine vielen materiellen Dinge brauchst – nur gute Gesellschaft, einen warmen Abend unter den Sternen und das richtige Fahrzeug, das dich zuverlässig ans Ziel bringt.", HR: "Ako prvi put krećete u kampiranje ili putovanje kombijem, ključ uspjeha je pametna i minimalistička priprema. Prednost putovanja okretnim kombijem je da vam ne treba puno stvari, jer je prostor iskorišten izuzetno funkcionalno. Spakirajte samo najnužnije: višenamjensku odjeću, osnovno posuđe za kuhanje na otvorenom, udobnu posteljinu i dobru svjetiljku.\n\nPrije polaska, okvirno zacrtajte rutu, ali ostavite prostora za spontanost. Provjerite lokacije kampova ili uređenih odmorišta za autodome gdje možete sigurno prenoćiti. Kampiranje s kombijem brzo će vas naučiti da za nezaboravan vikend ne trebate puno materijalnih stvari – samo dobro društvo, toplu večer pod zvijezdama i pravo vozilo koje vas pouzdano dovede do cilja." },
      },
      a4: {
        title: { SL: "Ideje za vikend izlet: Najlepše destinacije, dostopne s kombijem", EN: "Weekend trip ideas: The most beautiful destinations reachable by van", DE: "Ideen für Wochenend-Trips: Die schönsten Ziele, die mit dem Kombi erreichbar sind", HR: "Ideje za vikend izlet: Najljepše destinacije dostupne kombijem" },
        excerpt: { SL: "Soča, Logarska, Istra, Alpe – pot je pomembnejša od cilja.", EN: "Soča, Logarska, Istria, the Alps – the road matters more than the destination.", DE: "Soča, Logarska, Istrien, die Alpen – der Weg ist wichtiger als das Ziel.", HR: "Soča, Logarska, Istra, Alpe – put je važniji od cilja." },
        body: { SL: "Slovenija in njena okolica, tudi sosednje države, skrivata nešteto čudovitih kotičkov, ki kar kličejo po raziskovanju. Če načrtujete podaljšan vikend pobeg, je kompakten kombi idealen sopotnik. Omogoča vam, da raziščete neokrnjene predele doline reke Soče, se zapeljete po panoramskih cestah Logarske doline ali pa raziščete skrite kotičke slovenske Istre, kjer so ceste pogosto preozke za klasične velike avtodome.\n\nPrednost potovanja s kombijem je ravno v tem, da lahko dosežete tudi najbolj odmaknjene izhodiščne točke za pohodništvo, surfanje ali kolesarjenje. Spakirajte opremo, izberite svojo smer in uživajte v potovanju, kjer cilj ni najpomembnejši – pomembna je pot sama in svoboda, ki jo imate na vsakem kilometru.", EN: "Slovenia and its surroundings, including neighbouring countries, hide countless beautiful corners that call out to be explored. If you're planning an extended weekend escape, a compact van is the perfect companion. It lets you explore the untouched corners of the Soča valley, drive the panoramic roads of Logarska dolina, or discover the hidden gems of Slovenian Istria, where the roads are often too narrow for classic big motorhomes.\n\nThe advantage of travelling with a van is exactly this: you can reach the most remote starting points for hiking, surfing or cycling. Pack your gear, pick your direction and enjoy a trip where the destination is not the most important thing – the road itself and the freedom you have on every kilometer are.", DE: "Slowenien und seine Umgebung, einschließlich der Nachbarländer, verbergen unzählige wunderschöne Ecken, die nur darauf warten, erkundet zu werden. Wenn du einen verlängerten Wochenend-Trip planst, ist ein kompakter Kombi der perfekte Begleiter. Du kannst die unberührten Ecken des Soča-Tals erkunden, die Panoramastraßen des Logarska-Tals fahren oder die versteckten Schätze des slowenischen Istriens entdecken, wo die Straßen oft zu schmal für klassische große Wohnmobile sind.\n\nDer Vorteil des Reisens mit einem Kombi liegt genau darin: Du erreichst auch die abgelegensten Ausgangspunkte zum Wandern, Surfen oder Radfahren. Pack deine Ausrüstung, wähle deine Richtung und genieße eine Reise, bei der das Ziel nicht das Wichtigste ist – wichtig ist der Weg selbst und die Freiheit, die du auf jedem Kilometer hast.", HR: "Slovenija i okolica, uključujući susjedne države, kriju bezbroj prekrasnih kutaka koji vape za istraživanjem. Ako planirate produljeni vikend bijeg, kompaktni kombi je idealan suputnik. Omogućuje vam istraživanje netaknutih predjela doline rijeke Soče, vožnju panoramskim cestama Logarske doline ili otkrivanje skrivenih kutaka slovenske Istre, gdje su ceste često preuske za klasične velike autodome.\n\nPrednost putovanja kombijem upravo je u tome što možete doseći i najudaljenije polazne točke za planinarenje, surfanje ili biciklizam. Spakirajte opremu, odaberite svoj smjer i uživajte u putovanju gdje cilj nije najvažniji – važan je sam put i sloboda koju imate na svakom kilometru." },
      },
    },
  },
};
